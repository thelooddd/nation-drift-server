...
#define ShowInfoBox(%0,%1,%2,%3) do{format(CMDSString, 1000, %2, %3); ShowPlayerDialog(%0, HOUSEMENU-1, DIALOG_STYLE_MSGBOX, %1, CMDSString, "Закрыть", "Отмена");}while(FALSE)
...
//                              Important.
//------------------------------------------------------------------------------
#define LABELTEXT1 "Название дома: %s\nВладелец: No Owner\nЦена: $%d\nID: %d"
#define LABELTEXT2 "Название дома: %s\nВладелец: %s\nЦена: $%d\nID: %d"
#define FILEPATH "/GarHouse/Houses/%d.ini"
#define INFORMATION_HEADER "GarHouse v1.3 By [03]Garsino(перевод сайта samp-mods.com) - Информация"
//------------------------------------------------------------------------------
// 				Information and error messages
//------------------------------------------------------------------------------
#define E_NO_HOUSES_OWNED "Ты не владеешь никаким домом."
#define I_HMENU "Введи /housemenu, чтобы посмотреть меню домов."
#define E_H_ALREADY_OWNED "Этим домом уже ктото владеет."
#define E_INVALID_HPASS_LENGTH "Неправильная длина пароля."
#define E_INVALID_HPASS "Неправильный пароль. Вы не можете использовать этот пароль."
#define E_INVALID_HPASS_CHARS "Ваш пароль содержит неправильные символы (такие как ~)."
#define E_INVALID_HNAME_LENGTH "Неправильная длина названия дома."
#define E_INVALID_HNAME_CHARS "Название дома содержит неправильные символы(такие как ~)."
#define I_HPASS_NO_CHANGE "Ваш пароль от дома остался прежним."
#define I_HPASS_REMOVED "Пароль от дома был убран."
#define E_NOT_ENOUGH_PMONEY "У вас нету столько денег!"
#define E_INVALID_AMOUNT "Неправильное количество."
#define E_HSTORAGE_L_REACHED "Вы не можете держать столько денег в доме. Максимальная сумма $25,000,000."
#define E_NOT_ENOUGH_HSMONEY "У вас нету столько денег в доме!"
#define E_NO_WEAPONS "Вы не имеете никакого оружия."
#define E_NO_HS_WEAPONS "Вы не имеете никакогого оружия в доме."
#define E_INVALID_HPASS_CHARS2 "Пароль от входа в дом содержит неправильные символы (такие как ~)."
#define E_C_ACCESS_SE_HM "Вы не можете открыть меню чужого дома."
#define E_NOT_IN_HOUSE "Вы должны быть в доме чтобы использовать эту команду."
#define E_NOT_HOWNER "Вы должны быть владельцем дома чтобы использовать эту команду."
#define E_HCAR_NOT_IN_VEH "Вы должны быть в машине, чтобы добавить ее к дому."
#define E_INVALID_HID "Неправильный ID. Данный ID дома не существует."
#define E_NO_HCAR "В доме с этим ID нет машин. Невозможно удалить."
#define E_H_A_F_SALE "Этот дом уже поставлен на продажу. Вы не можете продать его."
#define HMENU_ENTER_PASS "Название дома: %s\nВладелец: %s\nЦена: $%d\nID: %d\n\nВведите пароль к дому если вы хотите войти:"
#define HMENU_BUY_HOUSE "%s, вы хотите купить дом за $%d?"
#define HMENU_BUY_HINTERIOR "Вы хотите купить интерьер дома %s за $%d?"
#define HMENU_SELL_HOUSE "%s, вы уверенны, что хотите продать дом %s за $%d?"
#define I_SELL_HOUSE1 "Вы успешно продали дом за $%d.\nПлата за продажу: $%d.\n$%d из вашего дома были возвращены вам."
#define I_SELL_HOUSE2 "Вы успешно продали дом \"%s\" за $%d.\nПлата за продажу: $%d."
#define I_BUY_HOUSE "Вы успешно купили дом за $%d!"
#define I_HPASSWORD_CHANGED "Вы успешно установили на дом пароль \"%s\"!"
#define I_HNAME_CHANGED "Вы успешно изменили имя дома на \"%s\"!"
#define E_ALREADY_HAVE_HINTERIOR "У вас уже есть этот интерьер дома."
#define I_VISITING_HOUSEINT "Сейчас вы посещаете интерьер %s.\nЕго цена $%d.\nВремя посещения закончится через %d минуты%s."
#define E_CANT_AFFORD_HINT "Вы не можете позволить купить себе интерьер %s.\nЦена интерьера дома: $%d.\nВы имеете: $%d.\nВам еще нужно: $%d."
#define I_HINT_BOUGHT "Вы купили интерьер %s за $%d."
#define I_HINT_DEPOSIT1 "У вас есть $%d на хранении в вашем доме.\n\nВведите сумму, которую вы хотите положить:"
#define I_HINT_WITHDRAW1 "У вас есть $%d на хранении в вашем доме.\n\nВведите сумму, которую выхотите снять:"
#define I_HINT_DEPOSIT2 "Вы успешно положили $%d в ваш дом на хранение.\nТекущий баланс: $%d"
#define I_HINT_WITHDRAW2 "Вы успешно сняли $%d из вашего дома.\nТекущий баланс: $%d"
#define I_HINT_CHECKBALANCE "У вас есть $%d на хранении в доме."
#define E_HINT_WAIT_BEFORE_VISITING "Пожалуйста подождите до посещения интерьера дома снова."
#define I_HS_WEAPONS1 "Вы успешно сохранили %d оружие%s в доме."
#define I_HS_WEAPONS2 "Вы успешно взяли %d оружие%s из дома."
#define I_WRONG_HPASS1 "Вы не вошли в дом игрока %s, используя пароль \"%s\"."
#define I_WRONG_HPASS2 "Информация: %s (%d) пытался войти в дом, используя пароль \"%s\"!"
#define I_CORRECT_HPASS1 "Вы успешно вошли в дом игрока %s, используя пароль \"%s\"!"
#define I_CORRECT_HPASS2 "Информация: %s (%d) успешно вошел в дом, используя пароль \"%s\"!"
#define E_TOO_MANY_HOUSES "Извините, но уже созданно %d домов.\nУдалите один или несколько или увеличьте лимит в скрипте."
#define E_INVALID_HVALUE "Неправильная цена дома. Цена должна быть в промежутке $1,500,000-$25,000,000."
#define I_H_CREATED "Дом с ID %d создан..."
#define I_HCAR_EXIST_ALREADY "Дом с ID %d уже имеет машину. Замените текущую машину."
#define I_HCAR_CREATED "Машина для дома с ID %d созданна..."
#define I_H_DESTROYED "Дом с ID %d удален..."
#define I_HCAR_REMOVED "Машина для дома с ID %d была удалена..."
#define I_ALLH_DESTROYED "Все дома удалены. (%d в итоге)"
#define I_ALLHCAR_REMOVED "Все машины к домам удалены. (%d в итоге)"
#define I_HSPAWN_CHANGED "Вы изменили позицию спавна и угол для дома с ID %d."
#define I_TELEPORT_MSG "Вы были телепортированны в дом с ID %d."
#define I_H_SOLD "Вы продали дом с ID %d..."
#define I_ALLH_SOLD "Все дома на сервере были проданны. (%d в итоге)"
#define I_H_PRICE_CHANGED "Цена за дом с ID %d была изменнена на $%d."
#define I_ALLH_PRICE_CHANGED "Вы изменили цену для всех домов на сервере на  $%d. (%d в итоге)"
#define I_HINT_VISIT_OVER "Ваше время посещения закончилось.\nВы хотите купить интерьер дома %s за $%d?"
#define E_INVALID_HCAR_MODEL "Неправильная модель машины. Разрешенны только в промежутке 400-612."
#define I_HCAR_CHANGED "Модель машины для дома с ID %d измененна на %d."
//------------------------------------------------------------------------------
#define E_CMD_USAGE_CREATEHOUSE "Использование: /createhouse (цена) (опционально: интерьер дома)"
...
#define E_CMD_USAGE_CHANGEHCAR "Использование: /changehcar (id дома) (id машины: 400-612)"
...
#define E_CMD_USAGE_CHANGEPRICE "Использование: /changeprice (id дома) (цена)"
#define E_CMD_USAGE_CHANGEALLPRICE "Использование: /changeallprices (цена)"
//------------------------------------------------------------------------------
//                          Debug messages
//------------------------------------------------------------------------------
#if defined GH_DEBUGGING
#define DEBUG_OP_DISCONNECT "[GarHouse Debug] (OnPlayerDisconnect) - %s (%d) Вышел из своего дома."
#define DEBUG_OP_ED_CP1 "[GarHouse Debug] (OnPlayerEnterDynamicCP) - %s (%d) Вошел в свой дом [House ID: %d]."
#define DEBUG_OP_ED_CP2 "[GarHouse Debug] (OnPlayerEnterDynamicCP) - %s (%d) вышел из дома с ID %d."
#define DEBUG_OP_PUD_PICKUP1 "[GarHouse Debug] (OnPlayerPickUpDynamicPickup) - %s (%d) Вошел в дом [House ID: %d]."
#define DEBUG_OP_PUD_PICKUP2 "[GarHouse Debug] (OnPlayerPickUpDynamicPickup) - %s (%d) Вышел из дома с ID %d."
#define DEBUG_ODR1 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Купил дом ID %d за $%d."
#define DEBUG_ODR2 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Изменил название дома с ID %d на %s."
#define DEBUG_ODR3 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Купил интерьер %s за $%d. [House ID: %d]."
#define DEBUG_ODR4 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Посетил интерьер %s [House ID: %d]."
#define DEBUG_ODR5 "[GarHouse Debug] (OnDialogResponse) - Интерьер для дома с ID %d был установлен на %d."
#define DEBUG_ODR6 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Проверил баланс в доме с ID %d. [Balance: $%d]"
#define DEBUG_ODR7 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Положил $%d в дом с ID %d."
#define DEBUG_ODR8 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Снял $%d из дома с ID %d."
#define DEBUG_ODR9 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Пложил %d оружие%s на хранение в дом с ID %d."
#define DEBUG_ODR10 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Пложил %d оружие%s на хранение в дом с ID %d."
#define DEBUG_ODR11 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Получил %d оружие%s из дома с ID %d."
#define DEBUG_ODR12 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Успешно вошел в дом с ID %d, используя пароль от дома."
#define DEBUG_ODR13 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Продал дом за $%d (Деньги в доме: $%d). [House ID: %d]"
#define DEBUG_ODR14 "[GarHouse Debug] (OnDialogResponse) - %s (%d) Изменил пароль от дома с ID %d."
#define DEBUG_OP_CMD1 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Создал дом. [House ID: %d | House Value: $%d | Total Houses: %d]"
#define DEBUG_OP_CMD2 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Создал машину к дому ID %d."
#define DEBUG_OP_CMD3 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Удалил дом с ID %d."
#define DEBUG_OP_CMD4 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Удалил машину от дома с ID %d."
#define DEBUG_OP_CMD5 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Удалил все дома на сервере. [%d In Total]"
#define DEBUG_OP_CMD6 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Удалил все машины от домов на сервере. [%d In Total]"
#define DEBUG_OP_CMD7 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Изменил позицию спавна и угол для дома с ID %d."
#define DEBUG_OP_CMD8 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) продал дом с ID %d."
#define DEBUG_OP_CMD9 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Продал все дома на сервере. [%d In Total]"
#define DEBUG_OP_CMD10 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Изменил цену дома с ID %d на $%d."
#define DEBUG_OP_CMD11 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Изменил цену всех домов на сервере на $%d. [%d In Total]"
#define DEBUG_OP_CMD12 "[GarHouse Debug] (OnPlayerCommandText) - %s (%d) Изменил модель машины к дому с ID %d на %d."
#define DEBUG_OP_SPAWN "[GarHouse Debug] (OnPlayerSpawn) - %s (%d) Спавнился в своем доме."
#endif
//------------------------------------------------------------------------------
//==============================================================================
//                              Awesomeness
        ...
        Loop(h, MAX_HOUSES) {
            ...
            if (checkpointid == HouseCPOut[h]) {
                ...
                if (strcmp(GetHouseOwner(h), pNick(playerid), CASE_SENSETIVE) && strcmp(GetHouseOwner(h), INVALID_HOWNER_NAME, CASE_SENSETIVE)) {
                    ...
                    if (strcmp(dini_Get(file, "HousePassword"), "INVALID_HOUSE_PASSWORD", CASE_SENSETIVE)) {
                        ...
                        ShowPlayerDialog(playerid, HOUSEMENU + 60, DIALOG_STYLE_INPUT, "GarHouse v1.3 By [03]Garsino - инфо о доме", string, "Войти", "Закрыть");
                    }
                }
                if (!strcmp(GetHouseOwner(h), INVALID_HOWNER_NAME, CASE_SENSETIVE) && dini_Int(file, "HouseValue") > 0 && GetPVarInt(playerid, "JustCreatedHouse") == 0) {
                    ...
                    ShowPlayerDialog(playerid, HOUSEMENU + 4, DIALOG_STYLE_MSGBOX, "GarHouse v1.3 By [03]Garsino - покупка дома", string, "Купить", "Отмена");
                }
                break;
            }
            if (checkpointid == HouseCPInt[h]) {
                ...
                if (GetPVarInt(playerid, "HousePreview") == 1) {
                    ...
                    ShowPlayerDialog(playerid, HOUSEMENU + 17, DIALOG_STYLE_MSGBOX, "GarHouse v1.3 By [03]Garsino - смена интерьера", string, "Купить", "Отмена");
                }
		        #endif
        ...
        Loop(h, MAX_HOUSES) {
            ...
            if (pickupid == HousePickupInt[h]) {
                ...
                if (GetPVarInt(playerid, "HousePreview") == 1) {
                    ...
                    GetPVarString(playerid, "HousePrevName", tmpstring, 50);
                    format(string, sizeof(string), HMENU_BUY_HINTERIOR, tmpstring, GetPVarInt(playerid, "HousePrevValue"));
                    ShowPlayerDialog(playerid, HOUSEMENU + 17, DIALOG_STYLE_MSGBOX, "GarHouse v1.3 By [03]Garsino - покупка интерьера", string, "Купить", "Отмена");
                }
		        #endif
                if (GetPVarInt(playerid, "HousePreview") == 0) {
                    SetPVarInt(playerid, "IsInHouse", 0);
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]) {
    ...
    if (dialogid == HOUSEMENU && response) {
        switch (listitem) {
            case 0: {
                ...
                ShowPlayerDialog(playerid, HOUSEMENU + 3, DIALOG_STYLE_MSGBOX, "GarHouse v1.3 By [03]Garsino - Продажа дома", string, "Продать", "Отмена");
            }
            case 1: {
				#if defined GH_USE_WEAPONSTORAGE
                ShowPlayerDialog(playerid, HOUSEMENU + 18, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Хранение в доме", "Деньги на хранении\nОружие на хранении", "Выбрать", "Отмена");
				#endif
				#if !defined GH_USE_WEAPONSTORAGE
                ShowPlayerDialog(playerid, HOUSEMENU + 10, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Хранение в доме", "Положить деньги\nВзять деньги\nПроверить баланс", "Выбрать", "Отмена");
				#endif
            }
            case 2 : ShowPlayerDialog(playerid, HOUSEMENU + 14, DIALOG_STYLE_INPUT, "GarHouse v1.3 By [03]Garsino - Название дома", "Введите новое название дома:\n\nНажмите 'Отмена' чтобы отменить", "Ок", "Отмена");
            case 3 : ShowPlayerDialog(playerid, HOUSEMENU + 13, DIALOG_STYLE_INPUT, "GarHouse v1.3 By [03]Garsino - Смена пароля от дома", "Введите новый пароль от дома:\nПокиньте меню если вы хотите оставить текущий пароль.\nНажмите 'Удалить', чтобы удалить пароль.", "Ок", "Удалить");
            case 4 : ShowPlayerDialog(playerid, HOUSEMENU + 16, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Выбор интерьера дома", "Посмотреть интерьер\nКупить текущий интерьер", "Выбрать", "Отмена");
        }
        return 1;
    }
    //------------------------------------------------------------------------------
    ...
    if (dialogid == HOUSEMENU + 4) {
        if (response) {
            ...
            if (GetOwnedHouses(playerid) >= MAX_HOUSES_OWNED) { ShowInfoBox(playerid, INFORMATION_HEADER, "Вы уже владеете %d дом%s. Продайте ваши дома до покупки нового.", MAX_HOUSES_OWNED, AddS(MAX_HOUSES_OWNED)); return 0; }
            ...
            if (GetHouseValue(h) > GetPlayerMoney(playerid)) { ShowInfoBox(playerid, INFORMATION_HEADER, "Вы не можете купить дом.\nСтоимость дома: $%d.\nУ вас: $%d.\nЕще нужно: $%d.", GetHouseValue(h), GetPlayerMoney(playerid), (GetHouseValue(h) - GetPlayerMoney(playerid))); return 0; } else {
    ...
    if (dialogid == HOUSEMENU + 16 && response) {
        ...
        ShowPlayerDialog(playerid, HOUSEMENU + 15, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - House Interior", string, "Купить", "Отмена");
        return 1;
    }
	#endif
    //------------------------------------------------------------------------------
    ...
    if (dialogid == HOUSEMENU + 10 && response) {
        ...
        if (listitem == 0) // Deposit
        {
            ...
            ShowPlayerDialog(playerid, HOUSEMENU + 11, DIALOG_STYLE_INPUT, "GarHouse v1.3 By [03]Garsino - Хранение в доме", string, "Положить", "Отмена");
        }
        if (listitem == 1) // Withdraw
        {
            format(string, sizeof(string), I_HINT_WITHDRAW1, tmp);
            ShowPlayerDialog(playerid, HOUSEMENU + 12, DIALOG_STYLE_INPUT, "GarHouse v1.3 By [03]Garsino - Хранение в доме", string, "Взять", "Отмена");
        }
    ...
    if (dialogid == HOUSEMENU + 18 && response) {
        switch (listitem) {
            case 0 : ShowPlayerDialog(playerid, HOUSEMENU + 10, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Хранение в доме", "Положить деньги\nВзять деньги\nТекущий баланс", "Выбрать", "Отмена");
            case 1 : ShowPlayerDialog(playerid, HOUSEMENU + 19, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Хранение в доме", "Положить текущее оружие\nПолучить оружие из дома", "Выбрать", "Отмена");
        }
    }
    //------------------------------------------------------------------------------
    //                          Weapon Storage
...
dcmd_housemenu(playerid, params[]) {
    ...
    if (GetPVarInt(playerid, "IsInHouse") == 1 && !strcmp(GetHouseOwner(GetPVarInt(playerid, "LastHouseCP")), pNick(playerid), CASE_SENSETIVE) && GetOwnedHouses(playerid) >= 1) {
	    #if defined GH_HINTERIOR_UPGRADE
        ShowPlayerDialog(playerid, HOUSEMENU, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Меню дома", "Продать дом\nХранение в доме\nУстановить название дома\nУстановить пароль\nКупить/Посмотреть интерьеры", "Выбрать", "Отмена");
		#endif
		#if !defined GH_HINTERIOR_UPGRADE
        ShowPlayerDialog(playerid, HOUSEMENU, DIALOG_STYLE_LIST, "GarHouse v1.3 By [03]Garsino - Меню дома", "Продать дом\nХранение в доме\nУстановить название дома\nУстановить пароль", "Выбрать", "Отмена");
		#endif
    }
    return 1;
}
...
dcmd_ghcmds(playerid, params[]) {
    ...
    if (!IsPlayerAdmin(playerid)) return 0;
        ...
        return ShowPlayerDialog(playerid, HOUSEMENU - 1, DIALOG_STYLE_MSGBOX, "GarHouse v1.3 By [03]Garsino - команды", "/changeallprices\n/removeallhcars\n/sellallhouses\n/changeprice\n/changespawn\n/removehcar\n/sellhouse\n/housemenu\n/gotohouse\n/addhcar\n/changehcar\n/ghcmds", "Закрыть", "Отмена");
    }
}
//##############################################################################
// 								      Publics
...
stock AddS(amount) {
    new returnstring[2];
    format(returnstring, 2, "ом");
    if (amount != 1 && amount != -1) {
        format(returnstring, 2, "ами");
    }
    return returnstring;
}
//==============================================================================
